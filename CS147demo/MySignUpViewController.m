...
- (void)viewDidLoad {
    ...
    [self.signUpView setLogo:[[UIImageView alloc] initWithImage:[UIImage imageNamed:@"StanfordSeal;gif"]]];
...
- (void)viewDidLayoutSubviews {
    ...
    [self.signUpView.dismissButton setFrame:CGRectMake(10.0f, 20.0f, 40.0f, 40.0f)];
    [self.signUpView.logo setFrame:CGRectMake(66.5f, 70.0f, 58.5f, 58.5f)];
    
    
    float widthScreen = self.view.frame.size.width;
    
    [self.signUpView.signUpButton setFrame:CGRectMake((widthScreen-145)/2, 455.0f, 145.0f, 60.0f)];
